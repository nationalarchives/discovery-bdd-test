...
{
    [Binding]
    public class SingleSignOnSteps
    {
        ...
        [When(@"I should see ""(.*)"", go to your personal details, change email ""(.*)""")]
        public void WhenIShouldSeeGoToYourPersonalDetailsChangeEmail(string welcomeMsg, string newEmail)
        {
            Thread.Sleep(1000);
        ...
        public void WhenSigninWithOldIShouldSee(string newEmail, string pswd, string welcomeMsg)
        {
